...
`,
  ...
  var InfiniteScroll = {
    ...
    destroyed() {
      var _a2;
      (_a2 = this.throttles) == null ? void 0 : _a2.forEach((throttled) => throttled.cancel());
      this.throttles = null;
      if (this.scrollContainer) {
  ...
  var LiveFileUpload = {
    ...
    hasSelectedFiles() {
      var _a2;
      return (((_a2 = this.el.files) == null ? void 0 : _a2.length) || 0) > 0 || LiveUploader.activeFiles(this.el).length > 0 || this.activeRefs() !== "" || this.errorRefs() !== "";
    },
    maybeRemoveRequired() {
        ...
        const morphCallbacks = {
          ...
          addChild: (parent, child) => {
            ...
            if (streamAt === 0) {
              ...
              const sibling = (_a2 = parent.children[streamAt]) != null ? _a2 : null;
    ...
    return {
      ...
      push(el, type, opts = {}) {
        liveSocket2.withinOwners(el, (view) => {
          const _a2 = opts, { value } = _a2, rest = __objRest(_a2, ["value"]);
          const data = value || {};
  ...
  var View = class _View {
    ...
    logError(code, message, metadata, context = { attribution: "unknown" }) {
      ...
      logError(code, message, metadata, __spreadValues({
        viewId: (_a2 = this.id) != null ? _a2 : this.el.id
      }, context));
    }
  ...
  var LiveSocket = class {
    ...
    constructor(url, phxSocket, opts = {}) {
      ...
      this.cascadePhxRemoveOnNavigation = (_a2 = opts.cascadePhxRemoveOnNavigation) != null ? _a2 : true;
    ...
    log(view, kind, msgCallback, diagnostic) {
      ...
      const level = (_a2 = diagnostic == null ? void 0 : diagnostic.level) != null ? _a2 : "debug";
  ...
  window.addEventListener("agentyard:copy", (event) => {
    var _a2, _b, _c;
    const target = document.querySelector(((_b = (_a2 = event.target) == null ? void 0 : _a2.dataset) == null ? void 0 : _b.to) || "#branch-name");
    if (target)
      (_c = navigator.clipboard) == null ? void 0 : _c.writeText(target.textContent.trim());
  });
})();
